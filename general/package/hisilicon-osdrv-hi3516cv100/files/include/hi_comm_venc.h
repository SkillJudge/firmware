...
{
    BASE_IDRSLICE = 0,                  //base���е�IDR֡
    BASE_PSLICE_REFBYBASE,              //base���е�P֡������base��������֡�Ĳο�
    BASE_PSLICE_REFBYENHANCE,           //base���е�P֡������enhance���е�֡�Ĳο�
    ENHANCE_PSLICE_REFBYENHANCE,        //enhance���е�P֡������enhance��������֡�Ĳο�
    ENHANCE_PSLICE_NOTFORREF,           //enhance���е�P֡�������ڲο�
    ENHANCE_PSLICE_BUTT
} H264E_REF_TYPE_E;
