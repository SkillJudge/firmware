...
general/overlay/usr/bin/sd_upgrade
...
general/overlay/root/encoder/actions/crash_snapshot.sh
general/overlay/root/encoder/actions/proc_restart.sh
general/overlay/root/encoder/actions/reboot.sh
